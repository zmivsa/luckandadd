        ...
        setTimeout(() => {
            ...
            $.post(url, async (err, resp, data) => {
                try {
                    ...
                    if (LZ_TOKEN_KEY && LZ_TOKEN_VALUE && !$.LZ_AES_PIN) r_cookie = `${LZ_TOKEN_KEY} ${LZ_TOKEN_VALUE}`
                    if (LZ_TOKEN_KEY && LZ_TOKEN_VALUE && $.LZ_AES_PIN) r_cookie = `${LZ_TOKEN_KEY} ${LZ_TOKEN_VALUE} ${$.LZ_AES_PIN}`
